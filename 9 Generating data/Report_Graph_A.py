...
sPicNameOut4='D:/MSC PRACS EXAM/DATA SCIENCE/OP/bar.png'
plt.tight_layout()
plt.savefig(sPicNameOut4,dpi=600)

os_new.iloc[:5].plot(figsize=(10, 10),kind='barh',x='Warehouse Location',\
           y=['Profit 2016','Profit 2017']);
sPicNameOut5='D:/MSC PRACS EXAM/DATA SCIENCE/OP/hbar.png'
plt.tight_layout()
...
sPicNameOut6='D:/MSC PRACS EXAM/DATA SCIENCE/OP/area.png' 
plt.tight_layout()
