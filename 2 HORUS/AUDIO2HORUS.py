...
sOutputFileName='D:/MSC PRACS EXAM/DATA SCIENCE/OP/HORUS-Audio-2ch.csv'
...
ProcessData.columns=sColumns
OutputData=ProcessData
sOutputFileName='D:/MSC PRACS EXAM/DATA SCIENCE/OP/HORUS-Audio-4ch.csv'
OutputData.to_csv(sOutputFileName, index = False)
#=============================================================
...
ProcessData.columns=sColumns
OutputData=ProcessData
sOutputFileName='D:/MSC PRACS EXAM/DATA SCIENCE/OP/HORUS-Audio-6ch.csv'
OutputData.to_csv(sOutputFileName, index = False)
#=============================================================
...
ProcessData.columns=sColumns
OutputData=ProcessData
sOutputFileName='D:/MSC PRACS EXAM/DATA SCIENCE/OP/HORUS-Audio-8ch.csv'
OutputData.to_csv(sOutputFileName, index = False)
print('=====================================================')
